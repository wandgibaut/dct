...
class PerceptualCodelet(dct.PythonCodelet):
    ...
    def proc(self, activation):
        mem = dct.get_memory_objects(self.root_codelet_dir, 'perceptual-input-memories/sensory-memory', 'inputs')
        # print(mem['I'])
        dct.set_memory_objects(self.root_codelet_dir, 'behavioral-input-memories/perceptual-memory', 'I', mem['I'],
                               'outputs')
